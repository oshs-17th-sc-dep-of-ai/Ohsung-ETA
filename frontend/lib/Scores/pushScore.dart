...
class LastScore extends StatelessWidget {
  final int grade;
  final int semester;
  const LastScore({super.key, required this.grade, required this.semester});
      ...
      children: [
        Container(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                BS[idx].subName + BS[idx].rank.toString(),
                              ...
                              onPressed: () {
                                try {
                                  if (idx != -1) {
                                    BS[idx] = BasicScore(
                                        subName: sub.text,
                                        rank: int.parse(ranking.text),
                                        time: int.parse(counting.text));
                                  } else {
